...
class LykkeLogWebpack {
  constructor(options) {
    ...
    lykke_log_deffered.console_original[a]?(lykke_log_deffered.console_original[a].apply(console,arguments),lykke_log_deffered.console.push({method:a,arguments:arguments})):(lykke_log_deffered.console_original[a](b),lykke_log_deffered.console.push({method:a,arguments:b}))}}},i=0;i<lykke_log_deffered.methods.length;i++)lykke_log_deffered.console_intercept(lykke_log_deffered.methods[i]);window.addEventListener("error",lykke_log_deffered.lykke_log_deffered_error_handler,!0);`;
  }
  apply(compiler) {
